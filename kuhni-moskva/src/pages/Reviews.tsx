...
const reviews: Review[] = [
  ...
  },
  {
    ...
    quote:
      "Эмалированные фасады это нечто! Я сначала сомневался, думал будут царапины через месяц, но пока все супер. Цвет яркий, рейки выполнены качественно. Монтаж сделали аккуратно. Очень доволен.",
    name: "Игорь М.",
  ...
  },
  {
    ...
    quote:
      "Шкаф прекрасен, все аккуратно, двери без зазоров, но одна полка чуть криво стояла - поправили быстро. В целом, очень довольна! Быстро сделали, монтаж прошёл гладко.",
    name: "Светлана Р.",
    images: ["/reviews/Reviewer_05_01.jpeg", "/reviews/Reviewer_05_02.jpeg", "/reviews/Reviewer_05_04.jpeg"],
  },
  {
    title: "Шкаф встроенный в пленке",
    quote:
      "Заказывали встроенный шкаф в пленке, делали под потолок. Честно, переживали, как встанет по размерам, но всё встало идеально. Пленка матовая, следов почти не остаётся, выглядит аккуратно и не дёшево. Открывается мягко, ничего не скрипит.",
    name: "Наталия В.",
    images: ["/reviews/Reviewer_06_01.jpg", "/reviews/Reviewer_05_03.jpeg"],
  },
  {
    title: "Кухня в эмали",
    quote:
