    ...
    <footer className="footer">
      <div className="container section" style={{paddingTop:24, paddingBottom:16}}>
        <div className="grid grid-3">
          <div>
            <div style={{fontWeight:700}}>Кухни и мебель</div>
            <div className="text-muted">Москва и МО • Гарантия 12 мес</div>
          </div>
          <div>
            ...
            <div className="text-muted">
              ...
              TG: <a href="https://t.me/kuhnyashkaf" target="_blank">@kuhnishkafi77</a><br/>
              Адрес: г. Москва, ул. Архитектора Щусева 5к1<br/>
            </div>
          </div>
          <div>
